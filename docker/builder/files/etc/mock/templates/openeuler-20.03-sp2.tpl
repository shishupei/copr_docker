...
[OS]
name=OS
baseurl=http://192.168.0.17/openEuler-20.03-LTS-SP2/OS/$basearch/
enabled=1
gpgcheck=1
...
[everything]
name=everything
baseurl=http://192.168.0.17/openEuler-20.03-LTS-SP2/everything/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
...
[EPOL]
name=EPOL
baseurl=http://192.168.0.17/openEuler-20.03-LTS-SP2/EPOL/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
...
[update]
name=update
baseurl=http://192.168.0.17/openEuler-20.03-LTS-SP2/update/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
...
[EPOL-update]
name=EPOL update
baseurl=http://192.168.0.17/openEuler-20.03-LTS-SP2/EPOL/update/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler
"""
