...
[OS]
name=OS
baseurl=http://192.168.0.17/openEuler-22.03-LTS-SP3/OS/$basearch/
enabled=1
gpgcheck=1
...
[everything]
name=everything
baseurl=http://192.168.0.17/openEuler-22.03-LTS-SP3/everything/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL]
name=EPOL
baseurl=http://192.168.0.17/openEuler-22.03-LTS-SP3/EPOL/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[update]
name=update
baseurl=http://192.168.0.17/openEuler-22.03-LTS-SP3/update/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
...
[EPOL-update]
name=EPOL update
baseurl=http://192.168.0.17/openEuler-22.03-LTS-SP3/EPOL/update/main/$basearch/
enabled=1
gpgcheck=1
gpgkey=file:///usr/share/distribution-gpg-keys/openeuler/RPM-GPG-KEY-openEuler-EulerMaker
"""
